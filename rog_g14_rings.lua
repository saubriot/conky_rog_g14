...
gauge = {
{
    ...
    graph_bg_colour=0x000000,      graph_bg_alpha=0.3,
    graph_fg_colour=0x1e1e1e,      graph_fg_alpha=1.0,
    hand_fg_colour=0x1e1e1e,       hand_fg_alpha=1.0,
    txt_radius=75,
    txt_weight=0,                  txt_size=0.0,
    txt_fg_colour=0x1e1e1e,        txt_fg_alpha=1.0,
